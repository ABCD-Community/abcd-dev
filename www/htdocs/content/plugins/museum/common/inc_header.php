...
// 2. Load Plugin specific messages (museum.tab and museum_help_info.tab)
$plugin_msgs = $langManager->loadPluginTranslations($pluginPath, 'museum', 'museum.tab', $lang);
$help_msgs   = $langManager->loadPluginTranslations($pluginPath, 'museum', 'museum_help_info.tab', $lang);
